    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: color.white }}>
      ...
      >
        <View style={styles.wrapper}>
          ...
          />
          <TabButton
            icon={<Image source={require("../asset/icon/message.png")} style={{ width: 25, height: 25 }} />}
            label="Messages"
            tabName="Messages"
          />
          <TabButton
            icon={<Image source={require("../asset/icon/notification.png")} style={{ width: 25, height: 25 }} />}
            label="Notifications"
